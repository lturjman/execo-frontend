...
import RedirectOnToken from "@/components/auth/RedirectOnToken";
        ...
        <div className="w-full max-w-[70vh] space-y-4">
          <div className=" bg-white flex flex-col rounded-2xl shadow-lg overflow-hidden text-center p-5 dark:bg-zinc-800">
            ...
            <div className="">
              ...
              recomposées, familles aidantes : enfin un partage qui respecte
              votre réalité. <strong>Pas de 50/50 par défaut</strong> : chacun
              contribue selon ses possibilités, en fonction de son{" "}
