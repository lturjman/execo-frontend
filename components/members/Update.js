  ...
  return (
    <div className="space-y-4">
      <div className="flex justify-between items-center">
        ...
        <Button onClick={() => onClose()} rounded className="bg-zinc-400">
      ...
      <div>
        ...
        <div className="my-3">
          ...
          <span
            className={`text-sm font-semibold ${editableMember.owner ? "text-purple-600" : "text-zinc-500"}`}
          >
            {editableMember.owner ? "Administrateur" : "Utilisateur"}
          </span>
        </div>
